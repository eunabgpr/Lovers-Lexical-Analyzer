...
RESERVED_WORDS = {
    "give": ("KEYWORD_IO_GIVE", "cin"),
    "express": ("KEYWORD_IO_EXPRESS", "cout"),
    "overshare": ("KEYWORD_IO_OVERSHARE", "getline"),
    "dear": ("KEYWORD_TYPE_INT", "int"),
    "dearest": ("KEYWORD_TYPE_FLOAT", "float"),
    "rant": ("KEYWORD_TYPE_STRING", "string"),
    "status": ("KEYWORD_TYPE_BOOL", "bool"),
    "forever": ("KEYWORD_IF", "if"),
    "more": ("KEYWORD_ELSE", "else"),
    "forevermore": ("KEYWORD_ELSEIF", "else if"),
    "choose": ("KEYWORD_SWITCH", "switch"),
    "phase": ("KEYWORD_CASE", "case"),
    "bareminimum": ("KEYWORD_DEFAULT", "default"),
    "for": ("KEYWORD_FOR", "for"),
    "while": ("KEYWORD_WHILE", "while"),
    "pursue": ("KEYWORD_DO_WHILE", "do while"),
    "breakup": ("KEYWORD_BREAK", "break"),
    "moveon": ("KEYWORD_CONTINUE", "continue"),
    "love": ("KEYWORD_MAIN", "main"),
    "periodt": ("KEYWORD_ENDL", "endl"),
    "const": ("KEYWORD_CONST", "const"),
    "redflag": ("BOOL_LITERAL_FALSE", "false"),
    "greenflag": ("BOOL_LITERAL_TRUE", "true"),
    "boundaries": ("KEYWORD_NAMESPACE", "namespace"),
    "comeback": ("KEYWORD_RETURN", "return"),
}
