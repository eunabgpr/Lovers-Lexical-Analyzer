define("vs/nls.messages.ru.js", ["./_commonjsHelpers-98qg88fe"], (function(_commonjsHelpers) {
  "use strict";
   ...
   *-----------------------------------------------------------*/
  var hasRequiredNls_messages_ru;
  function requireNls_messages_ru() {
    if (hasRequiredNls_messages_ru) return nls_messages_ru$1;
    hasRequiredNls_messages_ru = 1;
    ...
    return nls_messages_ru$1;
  }
  var nls_messages_ruExports = requireNls_messages_ru();
  const nls_messages_ru = /* @__PURE__ */ _commonjsHelpers.getDefaultExportFromCjs(nls_messages_ruExports);
  return nls_messages_ru;
}));
